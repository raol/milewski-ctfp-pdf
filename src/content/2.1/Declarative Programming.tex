...
defined declaratively; as in, \texttt{h} is a composite of \texttt{g}
after \texttt{f}:
...
or imperatively; as in, call \texttt{f} first, remember the result of
that call, then call \texttt{g} with the result:
...
of actions ordered in time. In particular, the call to \texttt{g} cannot
happen before the execution of \texttt{f} completes. At least, that's
...
\begin{figure}
\centering
\fbox{\includegraphics[width=1.56250in]{images/asteroids.png}}
\end{figure}
...
\begin{figure}
\centering
\fbox{\includegraphics[width=1.56250in]{images/snell.jpg}}
\end{figure}
...
\begin{figure}
\centering
\fbox{\includegraphics[width=1.56250in]{images/mortar.jpg}}
\end{figure}
...
\begin{figure}
\centering
\fbox{\includegraphics[width=1.56250in]{images/feynman.jpg}}
\end{figure}
